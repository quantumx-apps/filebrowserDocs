...
- Powers **indexed-size storage quotas** (folder and scope limits that use folder size). For upload-only caps or indexing-disabled sources, use **tracked usage** instead — see {{< doclink path="features/quotas/" text="Storage quotas" />}}.
